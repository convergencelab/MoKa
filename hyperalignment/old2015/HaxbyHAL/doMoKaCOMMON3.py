...
avg_vtx = build_avg_vtx(ds_all)

for i in range(0, len(ds_all)):
	top_voxels_S.append(fast_top_voxels(ds_all[i]['data'], avg_vtx['data'], len(avg_vtx['data'])))
...
top_voxels_t = fast_top_voxels_SCORE_META(avg_vtx['data'], todoles, len(avg_vtx['data']))						
...
for topz in range(400, 1100, 100):
#for topz in range(400, 500, 100):
	...
	#for i in range(15,16,1):
		...
		#for j in range (30,40,10):
			...
			#myGuy1 = DecisionTreeClassifier(max_depth=5)		
