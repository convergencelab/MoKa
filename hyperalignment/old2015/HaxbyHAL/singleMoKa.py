...
print "Top Voxels"
topV_t = fast_top_voxels(t['data'], s['data'], 500)
topV_s = fast_top_voxels(s['data'], t['data'], 500)


t['data'] = t['data'][topV_t]
s['data'] = s['data'][topV_s]
...
D_train, D_test, L_train, L_test = cross_validation.train_test_split(tData, labels, test_size = (float(50)/100.0), random_state=0)
...
print "SVM-SA"
print pig1.score(sData, labels)
print "KNN-SA"
print pig2.score(sData, labels)
print "\n"
