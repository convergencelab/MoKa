...
top_s = fast_top_voxels(s['data'],t['data'],250)
top_t = fast_top_voxels(t['data'],s['data'],250)
...
D_train, D_test, L_train, L_test = cross_validation.train_test_split(tData, labels, test_size = 0.3, random_state=0)
