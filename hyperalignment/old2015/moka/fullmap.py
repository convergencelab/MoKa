...
csvout = csv.writer(open('fullmap-stz.csv', 'w'))
...
for TV in range(40, 1501, 1):
	...
	for PC in range(2, 25, 1):
		...
		for holdOut in range(30, 85, 5):
			...
			#print "SVM-FA"
			score1.append(pig1.score(FA, labels))
			#print score1
			#print "KNN-FA"
			score2.append(pig2.score(FA, labels))
			#print score2
			#print "\n"
			score3.append(pig2.score(FA, labels))
			score4.append(pig2.score(FA, labels))
			score5.append(pig2.score(FA, labels))
			score6.append(pig2.score(FA, labels))
			score7.append(pig2.score(FA, labels))
